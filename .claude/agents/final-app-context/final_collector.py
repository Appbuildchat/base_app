...
Consolidates all analysis files from output-final-app-context/ into a single comprehensive markdown document.
"""
...
def main():
    ...
    input_dir = base_dir / "output-final-app-context"
    output_file = input_dir / "final-app-context.md"
