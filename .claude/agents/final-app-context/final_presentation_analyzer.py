...
def load_dart_files_from_list():
    ...
    list_dir = base_dir / "output" / "final-list"
...
def save_analysis_to_md(dart_file_path, analysis):
    ...
    base_dir = Path("/home/test1/aas/AAS_0.2.0/flutter-base-project")
    output_file = base_dir / "output-final-app-context" / "4.presentation-analysis.md"
...
def main():
    ...
    subprocess.run([sys.executable, str(Path(__file__).parent / "final_screen_list_generator.py")], check=True)
