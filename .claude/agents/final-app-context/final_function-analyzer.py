...
def save_analysis_to_md(function_file_path, analysis):
    ...
    base_dir = Path("/home/test1/aas/AAS_0.2.0/flutter-base-project")
    output_file = base_dir / "output-final-app-context" / "3.function-analysis.md"
