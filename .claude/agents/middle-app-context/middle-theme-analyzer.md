...
1. **Check Output Directory**: Verify if `output-middle-app-context/` directory exists, create if it doesn't
...
5. **Save Output**: Save the final report as `output-middle-app-context/5.theme-analysis.md`
...
When complete, save your analysis to `output-middle-app-context/5.theme-analysis.md` and respond with:
"Theme and design system analysis completed and saved to output-middle-app-context/5.theme-analysis.md"