---
name: nano-agent-grok-4-fast
description: A nano agent that can be used to execute a prompt using the x-ai/grok-4-fast model.
model: opus
color: green
...
mcp__nano-agent__prompt_nano_agent(agentic_prompt=PROMPT, model="x-ai/grok-4-fast", provider="openrouter")
