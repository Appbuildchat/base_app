---
name: nano-agent-gemini-2-5-flash
description: A nano agent that can be used to execute a prompt using the google/gemini-2.5-flash model.
model: opus
color: red
...
mcp__nano-agent__prompt_nano_agent(agentic_prompt=PROMPT, model="google/gemini-2.5-flash", provider="openrouter")
