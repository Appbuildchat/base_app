---
name: nano-agent-grok-code-fast-1
description: A nano agent that can be used to execute a prompt using the x-ai/grok-code-fast-1 model.
model: opus
color: cyan
...
mcp__nano-agent__prompt_nano_agent(agentic_prompt=PROMPT, model="x-ai/grok-code-fast-1", provider="openrouter")
