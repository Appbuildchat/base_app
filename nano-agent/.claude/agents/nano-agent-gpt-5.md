...
description: A nano agent that can be used to execute a prompt using the openai/gpt-5 model.
model: opus
color: green
...
mcp__nano-agent__prompt_nano_agent(agentic_prompt=PROMPT, model="openai/gpt-5", provider="openrouter")
