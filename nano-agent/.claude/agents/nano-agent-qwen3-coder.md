---
name: nano-agent-qwen3-coder
description: A nano agent that can be used to execute a prompt using the qwen/qwen3-coder model.
model: opus
color: orange
...
mcp__nano-agent__prompt_nano_agent(agentic_prompt=PROMPT, model="qwen/qwen3-coder", provider="openrouter")
