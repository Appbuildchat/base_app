---
name: nano-agent-sonoma-sky-alpha
description: A nano agent that can be used to execute a prompt using the openrouter/sonoma-sky-alpha model.
model: opus
color: purple
...
mcp__nano-agent__prompt_nano_agent(agentic_prompt=PROMPT, model="openrouter/sonoma-sky-alpha", provider="openrouter")
